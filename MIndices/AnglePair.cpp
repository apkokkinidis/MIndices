...
int32_t AnglePair::CalculateIndices(const std::vector<VecPoint3D>& elements)
{
	...
	for (size_t i = 0; i < elements.size() - 1; i++)
	{
		...
		//increase step by 2 taking each pair of 2 point32_ts
		...
		sumM += sum;
		//calculate distances between point32_ts
	}
...
/*The distance formula states that the distance between two point32_ts in xyz-space
